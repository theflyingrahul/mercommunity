...
def merlan(request):
    if request.method == 'POST':
        ...
        file_object = file1(name=uploaded_file.name[0:48], fmt=ext, uploaded_by="rah", file_size=int(uploaded_file.size/1024/1024), date_time=datetime.datetime.now(), url="abc.txt")
        file_object.save()
